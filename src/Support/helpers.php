...
if ( ! function_exists('admin_extension') ) {
    function admin_extension( string $name )
    {
...
if ( ! function_exists('admin_extension_default') ) {
    /**
     * Return the extension default value.
     *
     * @param $key
     * @param $default
     *
     * @return array|\ArrayAccess|\Illuminate\Config\Repository|\Illuminate\Contracts\Foundation\Application|\Illuminate\Foundation\Application|mixed
     */
    function admin_extension_default( $key = null, $default = null )
    {
        if ( $key === null ) {
            return config('admin.extension.default');
        }
        
        return \Illuminate\Support\Arr::get(config('admin.extension.default'), $key, $default);
    }
}
...
if ( ! function_exists('directory') ) {
     ...
     * @throws \Exception
     */
    function directory( $path, int $output = Helper::DIRECTORY_OUTPUT_ARRAY )
    {
        return \Dcat\Admin\Support\Helper::directory($path, $output);
    }
}
